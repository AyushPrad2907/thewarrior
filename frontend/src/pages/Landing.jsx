...
const Landing = () => {
  ...
  const impactStats = [
    ...
    { value: 'Unlock', label: '  ', hindi: 'यह पुस्तक आपमें विद्यमान अनंत शक्ति को जाग्रत करने के लिए है। आप अपनी क्षमता को पहचानो। असंख्य  संभावनाएं आपके कदमों को अपने धरातल पर आकर्षित करेंगे। उन कदमों को मत रोको। उन्हें बढ़ने दो। उन्हें पूर्णता की ओर जाने दो।' }
  ];
    ...
    <div className="landing">
      ...
      <section className="features" data-reveal>
        ...
        <p className="section-subtitle">
          आपके जीवन में बदलाव लाने वाली एक प्रसिद्ध पुस्तक जो मष्तिष्क में आशा की भावना को जन्म देती है सकारात्मक सोच से आप अपने जीवन बदलने की संकल्प लेती हैं ।यह पुस्तक आपको इतिहास की प्रवाह में प्रवाहित नहीं बल्कि आपमें इतिहास की दिशा बदलने में शक्ति उत्पन्न करती है   ।
        </p>
      ...
      <section className="cta-section glass" data-reveal>
        ...
        <p className="cta-subtitle">
          आप जीवन के किसी भी क्षेत्र में क्यों न शिखर पर पहुंचना चाहते है। इस पुस्तक को अवश्य पढ़ें और कर्तव्यपथ पर रहे, सफलता मिलेगी ही। आपका उज्जवल भविष्य का आधार ही वर्तमान का निर्णय है। आगे बढ़ें और जीवन की सार्थकता को स्पष्ट करें। 
        </p>
